...
const contractABI = require("../artifacts/contracts/Developerdao.sol/Developerdao.json").abi;

program
    .name("developerdao-cli")
    .description("CLI tool for Developerdao smart contract")
    .version("1.0.0");
